...
function newsettime(){
        ...
        if(a==hrs)
        {
            ...
            document.querySelector("#right-inner2").style.backgroundImage="url(./assets/wakeup.jpg)";
        }
        if(b==hrs)
        {
            document.querySelector("#right-inner1").innerText="Let's Have Some Food";
            document.querySelector("#right-inner2").style.backgroundImage="url(./assets/lunch_image.png)";
        }
        if(c==hrs)
        {
            document.querySelector("#right-inner1").innerText="Let's Go For Sleep";
            document.querySelector("#right-inner2").style.backgroundImage="url(./assets/nap_image.png)";
        }
}
